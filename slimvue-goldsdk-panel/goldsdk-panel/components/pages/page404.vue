<template>
    <div class="wscn-http404-container">
        <div class="wscn-http404">
            <div class="pic-404">
                <img class="pic-404__parent" src="@/assets/pic404.png" alt="404">
            ...
            <div class="bullshit">
                ...
                <a @click='toDashborad' class="bullshit__return-home">返回首页</a>
            </div>
        </div>
    </div>
</template>
...
<script>
    export default {
        ...
        methods: {
            toDashborad() {
                window.sessionStorage.setItem('defaultActive', '/dashBoard')
